 ...
 */        !function(e, t) {
        ...
        if (document.querySelector(".selecting-tour__slider")) new core(".selecting-tour__slider", {
        ...
        function menuSearch() {
            ...
            if (searchIcon) if (document.documentElement.clientWidth < 767.98) searchIcon.addEventListener("click", (function(e) {
                bodyLock();
            ...
            const selectOnClick = () => {
                document.querySelectorAll(".cell_wrapper").forEach((cell => {
                    ...
                    if (cell) cell.addEventListener("click", (function(e) {
                        ...
                        if (calendarItemFifth) document.documentElement.classList.add("_active-wek-fifth"); else document.documentElement.classList.remove("_active-wek-fifth");
                        ...
                        if (calendarItemsSixth) document.documentElement.classList.add("_active-wek-sixth"); else document.documentElement.classList.remove("_active-wek-sixth");
                        ...
                        if (calendarItemSeventh) document.documentElement.classList.add("_active-wek-seventh"); else document.documentElement.classList.remove("_active-wek-seventh");
                    }));
        ...
        document.querySelector(".form-popup__total-new-price-2");
        const totalSum = document.querySelector(".price-tour-card__total-sum");
        document.querySelector(".price-tour-card__total-sum-2");
        if (totalPrice) totalPrice.innerText = totalSum.innerText;
        const inputTotals = document.querySelectorAll(".input-calc");
        ...
        const inputStudentsMasterСlass = document.querySelector("#number-4");
        const numberStudentsPrice = parseInt(document.querySelector(".it-price-students").innerHTML);
        parseInt(document.querySelector(".it-price-students-five").innerHTML);
        const numberAttendantsPrice = parseInt(document.querySelector(".it-price-attendants").innerHTML);
        const numberAttendantsPriceFive = parseInt(document.querySelector(".it-price-attendants-five").innerHTML);
        const numberAttendants = parseInt(document.querySelector(".number-attendants").innerHTML);
        function calculate() {
            let totalPriceElement = parseInt(inputNumberStudents.value);
            if (numberStudentsPrice) totalPriceElement *= numberStudentsPrice;
            const selectOptions = document.querySelectorAll(".select__option");
            selectOptions.forEach((option => {
                const selectOptionAttribute = parseInt(option.getAttribute("data-price-class"));
                option.addEventListener("click", (function(e) {
                    console.log(selectOptionAttribute);
                    totalPriceElement += selectOptionAttribute;
                }));
            }));
            const optionsOther = document.querySelector(".form-popup__options-other");
            if (optionsOther) radioType_2.forEach((radio_2 => {
                if (true === radio_2.checked) {
                    radioType_1.value = 0;
                    if (true === radioType_1.checked) {
                        document.documentElement.classList.add("_active-option");
                        totalPriceElement += parseInt(inputStudentsMasterСlass.value) * parseInt(radio_2.value);
                    } else document.documentElement.classList.remove("_active-option");
                }
            }));
            radioType.forEach((radio => {
                if (true === radio.checked) totalPriceElement += parseInt(radio.value);
            }));
            if (inputNumberAttendants.value >= numberAttendants) {
                const inputNumberAttendantsSum = parseInt(inputNumberAttendants.value) * numberAttendantsPrice - numberAttendantsPrice * numberAttendants;
                const inputNumberAttendantsSum_2 = parseInt(inputNumberAttendants.value) * numberAttendantsPriceFive - numberAttendantsPriceFive * numberAttendants;
                totalPriceElement += inputNumberAttendantsSum;
                if (numberAttendantsPrice) {
                    totalPriceElement += inputNumberAttendantsSum;
                    console.log(totalPriceElement);
                }
                if (numberAttendantsPriceFive) totalPriceElement += inputNumberAttendantsSum_2;
            } else if (inputNumberAttendants.value <= numberAttendants) {
                const inputNumberAttendantsSum_3 = 0 * parseInt(inputNumberAttendants.value);
                totalPriceElement += inputNumberAttendantsSum_3;
            }
